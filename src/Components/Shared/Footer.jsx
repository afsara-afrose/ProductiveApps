...
const Footer = () => {
    return (
    <footer className="bg-purple-300  py-10">
      <div className="container mx-auto px-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        ...
        <div className="text-center sm:text-left">
          ...
          <p>Email: support@productiveapps.com</p>
          <p>Phone: +880 1234 567 890</p>
          <p>Address: 123 Bonani Street, Dhaka, Bangladesh</p>
      ...
      <div className="text-center mt-10 border-t border-gray-700 pt-5 text-sm">
        &copy; {new Date().getFullYear()} ProductiveApps. All rights reserved.
      </div>
    </footer>
    );
};
